...
public static class Raylib
{
	...
	public const int32 RAYLIB_VERSION_MINOR = 6;
	
	public const int32 RAYLIB_VERSION_PATCH = 0;
	
	public const char8* RAYLIB_VERSION = "5.6-dev";
	...
	[CLink]
	public static extern void SeekMusicStreamFrame(Music music, int32 frame);
	...
	[CLink]
	public static extern int32 GetMusicFrame(Music music);
	...
	/// Seek music to a frame
	[Inline]
	public static void SeekMusicStreamFrame(Music music, int32 frame)
	{
		SeekMusicStreamFrame_Impl(music, frame);
	}
	[LinkName("SeekMusicStreamFrame")]
	private static extern void SeekMusicStreamFrame_Impl(in Music music, int32 frame);
	...
	/// Get current music frame
	[Inline]
	public static int32 GetMusicFrame(Music music)
	{
		return GetMusicFrame_Impl(music);
	}
	[LinkName("GetMusicFrame")]
	private static extern int32 GetMusicFrame_Impl(in Music music);
